...
export const getLookupOrdersQueryOptions = <TData = Awaited<ReturnType<typeof lookupOrders>>, TError = ErrorType<ErrorResponse>>(params: LookupOrdersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof lookupOrders>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useLookupOrders<TData = Awaited<ReturnType<typeof lookupOrders>>, TError = ErrorType<ErrorResponse>>(
